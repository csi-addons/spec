...
build: install-deps
	# generate libs
	cd .. && ./bin/protoc --go_out=lib/go --go_opt=paths=source_relative --go_opt=Mgithub.com/container-storage-interface/spec/lib/go/csi/csi.proto=github.com/container-storage-interface/spec/lib/go/csi --plugin=./bin/protoc-gen-go $(OPERATION)/$(OPERATION).proto
	cd .. && ./bin/protoc --go-grpc_out=lib/go --go-grpc_opt=paths=source_relative --go-grpc_opt=Mgithub.com/container-storage-interface/spec/lib/go/csi/csi.proto=github.com/container-storage-interface/spec/lib/go/csi --plugin=./bin/protoc-gen-go-grpc $(OPERATION)/$(OPERATION).proto
