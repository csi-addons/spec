...
var file_replication_proto_extTypes = []protoimpl.ExtensionInfo{
	{
		...
		Tag:           "varint,1059,opt,name=replication_secret",
...
var (
	...
	//
	// optional bool replication_secret = 1059;
...
var file_replication_proto_rawDesc = []byte{
	...
	0x73, 0x18, 0xa3, 0x08, 0x20, 0x01, 0x28, 0x08, 0x52, 0x11, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63,
