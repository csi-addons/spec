...
// Type describes a CSI Service that CSI-drivers can support.
type Capability_Healer_Type int32

const (
	// UNKNOWN indicates that the CSI-driver does not support the Healer
	// operation in the current mode. The CSI-Addons CO plugin will most
	// likely ignore this node for the Healer operation.
	Capability_Healer_UNKNOWN Capability_Healer_Type = 0
	// HEALER indicates that the CSI-driver provides RPCs for a
	// Healer operation.
	// The presence of this capability determines whether the CSI-Addons CO
	// plugin can invoke RPCs that require access to the storage system,
	// similar to the CSI Controller (provisioner).
	Capability_Healer_HEALER Capability_Healer_Type = 1
)

// Enum value maps for Capability_Healer_Type.
var (
	Capability_Healer_Type_name = map[int32]string{
		0: "UNKNOWN",
		1: "HEALER",
	}
	Capability_Healer_Type_value = map[string]int32{
		"UNKNOWN": 0,
		"HEALER":  1,
	}
)

func (x Capability_Healer_Type) Enum() *Capability_Healer_Type {
	p := new(Capability_Healer_Type)
	*p = x
	return p
}

func (x Capability_Healer_Type) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Capability_Healer_Type) Descriptor() protoreflect.EnumDescriptor {
	return file_identity_identity_proto_enumTypes[3].Descriptor()
}

func (Capability_Healer_Type) Type() protoreflect.EnumType {
	return &file_identity_identity_proto_enumTypes[3]
}

func (x Capability_Healer_Type) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Capability_Healer_Type.Descriptor instead.
func (Capability_Healer_Type) EnumDescriptor() ([]byte, []int) {
...
func (x *Capability) GetHealer() *Capability_Healer {
	if x, ok := x.GetType().(*Capability_Healer_); ok {
		return x.Healer
	}
	return nil
}
...
type Capability_Healer_ struct {
	// Healer operation capabilities
	Healer *Capability_Healer `protobuf:"bytes,4,opt,name=healer,proto3,oneof"`
}
...
func (*Capability_Healer_) isCapability_Type() {}
...
// CSI-driver supports.
type Capability_Healer struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// type contains the Type of CSI Service that the CSI-driver supports.
	Type Capability_Healer_Type `protobuf:"varint,1,opt,name=type,proto3,enum=identity.Capability_Healer_Type" json:"type,omitempty"`
}

func (x *Capability_Healer) Reset() {
	*x = Capability_Healer{}
	if protoimpl.UnsafeEnabled {
...
func (x *Capability_Healer) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Capability_Healer) ProtoMessage() {}

func (x *Capability_Healer) ProtoReflect() protoreflect.Message {
	mi := &file_identity_identity_proto_msgTypes[11]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Capability_Healer.ProtoReflect.Descriptor instead.
func (*Capability_Healer) Descriptor() ([]byte, []int) {
	return file_identity_identity_proto_rawDescGZIP(), []int{4, 3}
}

func (x *Capability_Healer) GetType() Capability_Healer_Type {
	if x != nil {
		return x.Type
	}
	return Capability_Healer_UNKNOWN
}
...
var file_identity_identity_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0xe9, 0x05, 0x0a, 0x0a, 0x43, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79,
	...
	,
	...
	0x56, 0x49, 0x43, 0x45, 0x10, 0x02, 0x1a, 0x78, 0x0a, 0x0c, 0x52, 0x65, 0x63, 0x6c, 0x61, 0x69,
	0x6d, 0x53, 0x70, 0x61, 0x63, 0x65, 0x12, 0x3a, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x26, 0x2e, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x2e,
	0x43, 0x61, 0x70, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x2e, 0x52, 0x65, 0x63, 0x6c, 0x61,
	0x69, 0x6d, 0x53, 0x70, 0x61, 0x63, 0x65, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79,
	0x70, 0x65, 0x22, 0x2c, 0x0a, 0x04, 0x54, 0x79, 0x70, 0x65, 0x12, 0x0b, 0x0a, 0x07, 0x55, 0x4e,
	...
	0x1a, 0x72, 0x0a, 0x0c, 0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x46, 0x65, 0x6e, 0x63, 0x65,
	...
	,
	...
	0x79, 0x2e, 0x50, 0x72, 0x6f, 0x62, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22,
	0x00, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x3b, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x62,
...
var file_identity_identity_proto_goTypes = []interface{}{
	...
	(Capability_Healer_Type)(0),       // 3: identity.Capability.Healer.Type
	...
	(*Capability_Healer)(nil),         // 15: identity.Capability.Healer
...
var file_identity_identity_proto_depIdxs = []int32{
	...
	15, // 5: identity.Capability.healer:type_name -> identity.Capability.Healer
	...
	3,  // 10: identity.Capability.Healer.type:type_name -> identity.Capability.Healer.Type
...
func file_identity_identity_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_identity_identity_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Capability_Healer); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
